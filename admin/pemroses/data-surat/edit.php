<?php 
    ...
    if ($file != "") { 
        ...
        //script untuk mengubah foto yang ada di folder dengan inputan dari user/pengguna
        $id_surat = $_GET['id_surat'];
        $sql = "SELECT * FROM surat WHERE id_surat='$id_surat'";
        $hapus = mysqli_query($connect,$sql);
        $data = mysqli_fetch_array($hapus);
		...
		move_uploaded_file($file, "../../image/storage/".$filename."");
