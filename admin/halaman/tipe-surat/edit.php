	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">Form Edit Kategori Surat Masuk</div>
				<div class="panel-body">
					<div class="col-md-12">
						<?php 
						 ...
						 ?>
						<form class="form-horizontal" action="pemroses/tipe-surat/edit.php?id_kategori_surat=<?php echo $data['id_kategori_surat']; ?>" method="post">
							<fieldset>
								<!-- Nama Tipe Surat-->
								<div class="form-group">
									<label class="col-md-4 control-label" for="name">Kategori Surat Masuk</label>
									<div class="col-md-8">
										<input id="name" name="nama_kategori_surat" type="text" placeholder="kategori surat masuk" class="form-control" value="<?php echo $data['nama_kategori_surat']; ?>" required>
									</div>
								</div>
