			...
			<div class="panel panel-default">
				<div class="panel-heading">Tabel Data Surat</div>
					<div class="panel-body">
						<div class="col-md-12">
							<div class="row">
								<table class="table" id="tabelDataSurat">
								    <thead>
								    	<tr class="headings">
								    		<th width="1%">No</th>
								    		<th width="30%">Nomor Surat Dan Perihal</th>
								    		<th width="20%">Instansi</th>
								    		<th width="27%">Tanggal Diterima</th>
								    		<th width="8%%">Aksi</th>
								    	</tr>
								    </thead>
								    <tbody>
								    	...
								    	<tr class="even pointer">
								    		...
								    		<td>
								    			<a href="index.php?p=data-surat/detail&id_surat=<?php echo $data['id_surat']; ?>" class="btn btn-info btn-sm"> <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> Detail</a>
								    		</td>
								    	</tr>
								    	<?php 
								    		}
