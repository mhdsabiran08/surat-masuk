						...
						<div class="col-md-12">
							<div class="row">
								<?php
								 ...
								 ?>
								<form class="form-horizontal col-md-10 col-md-offset-1" action="pemroses/data-surat/edit.php?id_surat=<?php echo $data['id_surat']; ?>" method="post" enctype="multipart/form-data">
